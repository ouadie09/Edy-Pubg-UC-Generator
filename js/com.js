var commentusername = [
    ...
    "كَفووووو ",
    " والله شغالة مبصدق",
    "لازم يبقى سر بيننا شباب",
    "مااشتغل معى فهاتفي. واشتغل فجوال ابي ههه",
    "حصلت على شدات اكثر",
    "شباب يمكنكم الاستفادة عدة مرات فقط استعمل هاتف آخر ",
    "اخدت شدات من زمان كله قانوني ماتخافو",
    "نعم شغالة شكرا شكرا شكرا",
    "ايوه ولعوها",
    "أصدقائي اشتروا روايال باس وانا اخدتو مجانا ههه",
    " ",
    " ",
    " ",
    "",
    ...
    "",
    "يشتغل مرة وحده وبس ",
    "وصلنى الشحن بعد ساعة شكرا",
    "شباب ماتشاركوا الموقع رح يقفل",
    "الآن عرفت من وين يشحنوا مجانا و يخفو علينا حرام",
    "ماعم صدق حالي",
    "دلع دلع دلع!!",
    "أخيرا اشتغلت معي بعد محاولات كثيرة شكرا لكم",
    "رائع شباب",
    "رح اشاركوا مع أصدقائي",
    "شكر على الشدات كنت محتاج اشتري بذلة",
    "",
    "",
    "",
    "",
    ...
    "",
    "",
    "والله مجنون الموقع ده ",
    "والله وصلت بعد التسجيل برقمي",
    "فعلتها فهاتفي وهاتف ابي وهاتف اختي ههه وحصلت على شدات مضاعفة",
    "شكرا على الهدية",
    " ",
    " ",
    " ",
